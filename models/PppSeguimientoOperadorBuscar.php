...
class PppSeguimientoOperadorBuscar extends PppSeguimientoOperador
{
    ...
    {
        return [
            [['id', 'id_tipo_seguimiento', 'id_ie', 'id_persona_responsable', 'numero_participantes', 'estado', 'id_indicador', 'id_operador', 'id_objetivo', 'id_actividad'], 'integer'],
            [['email', 'cual_operador', 'proyecto_reportar', 'mes_reporte', 'semana_reporte', 'descripcion_actividad', 'poblacion_beneficiaria', 'quienes', 'duracion_actividad', 'logros_alcanzados', 'dificultadades', 'avances_cumplimiento_cuantitativos', 'avances_cumplimiento_cualitativos', 'dificultades', 'propuesta_dificultades'], 'safe'],
        ];
    }
