...
/**
 * This is the model class for table "documentos_instancias_institucionales".
 *
 * @property string $id
 ...
 */
class DocumentosInstanciasInstitucionales extends \yii\db\ActiveRecord
{
    ...
    {
        return 'documentos_instancias_institucionales';
    }
