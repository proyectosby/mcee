...
/**
 * This is the model class for table "infraestructura_tecnologica".
 *
 * @property int $id
 ...
 */
class InfraestructuraTecnologica extends \yii\db\ActiveRecord
{
    public $file;
    /**
     * @inheritdoc
    ...
    {
        return 'infraestructura_tecnologica';
    }
