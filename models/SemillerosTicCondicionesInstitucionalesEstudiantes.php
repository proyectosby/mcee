...
class SemillerosTicCondicionesInstitucionalesEstudiantes extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_fase', 'id_ciclo', 'id_datos_ieo_profesional_estudiantes', 'estado'], 'integer'],
            [['parte_ieo', 'parte_univalle', 'parte_sem', 'otro', 'participantes_por_curso', 'promedio_estudiantes_por_curso', 'total_sesiones', 'total_estudiantes'], 'string'],
