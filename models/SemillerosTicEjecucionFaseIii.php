...
class SemillerosTicEjecucionFaseIii extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['docente_creador', 'asignatura', 'docente_usuario', 'grado', 'numero_estudiantes', 'numero_apps_usadas', 'nombre_aplicaciones', 'tic', 'tipo_recurso_tic', 'digitales', 'tipo_recurso_digital', 'escolares_no_tic', 'tipo_recurso_no_tic', 'tiempo_uso_recurso_tic', 'observaciones', 'total_aplicaciones_usadas', 'numero', 'tipo_de_produccion', 'temas_escolares', 'indice_problematicas', 'fecha_uso_aplicaciones','estudiantes_cultivadores'], 'string'],
