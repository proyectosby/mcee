...
$( "#selFases" ).change(function() 
{
	...
	fase = $( "#selFases" ).val();
	 ...
	 if(fase != "")
	 {
		 if(fase == 1){fase=14; titulo="BITACORA FASE I";}
		 else if(fase == 2){fase = 15; titulo="BITACORA FASE II";}
		 else if(fase == 3){fase = 16; titulo="BITACORA FASE III"}
		$.get( "index.php?r=semilleros-tic-diario-de-campo-estudiantes/opciones-ejecucion-diario-campo&idFase="+fase,
				function( data )
					{			
						$("#titulo").html(titulo);
