...
function agregarCampos(){
	...
	$.post( 
		"index.php?r=modelo-pedagogico/agregar-campos",
		{
		...
		function( data ){
            ...
            $( "#w0" ).yiiActiveForm( 'add', {
				"id":"modelopedagogico-"+consecutivo.toString()+"-descripcion",
				"name":"["+consecutivo.toString()+"]descripcion",
				"container":".field-modelopedagogico-"+consecutivo.toString()+"-descripcion",
				"input":"#modelopedagogico-"+consecutivo.toString()+"-descripcion",
			...
			$( "#w0" ).yiiActiveForm( 'add', {
				"id":"modelopedagogico-"+consecutivo.toString()+"-tipo_documento_id",
				"name":"["+consecutivo.toString()+"]tipo_documento_id",
				"container":".field-modelopedagogico-"+consecutivo.toString()+"-tipo_documento_id",
				"input":"#modelopedagogico-"+consecutivo.toString()+"-tipo_documento_id",
				"validate":function (attribute, value, messages, deferred, $form) {
			...
			$( "#w0" ).yiiActiveForm( 'add', {
				"id":"modelopedagogico-"+consecutivo.toString()+"-file",
				"name":"["+consecutivo.toString()+"]file",
				"container":".field-modelopedagogico-"+consecutivo.toString()+"-file",
				"input":"#modelopedagogico-"+consecutivo.toString()+"-file",
				"validate":function (attribute, value, messages, deferred, $form) {
			...
			$( "#w0" ).yiiActiveForm( 'add', {
				"id":"modelopedagogico-"+consecutivo.toString()+"-estado",
				"name":"["+consecutivo.toString()+"]estado",
				"container":".field-modelopedagogico-"+consecutivo.toString()+"-estado",
				"input":"#modelopedagogico-"+consecutivo.toString()+"-estado",
				"validate":function (attribute, value, messages, deferred, $form) {
