...
<div class="container-fluid">
            <div class="ieo-form">
                    ...
                    <?= $form->field($avances, "[$contador]estado_actual")->DropDownList($estadoActual,['prompt' => 'Seleccione','value' => $datos[$contador]['estado_actual'],'onchange'=>'selector(this);'])->label('Estado Actual') ?>
                    <?= $form->field($avances, "[$contador]logros")->textInput([ 'value' => $datos[$contador]['logros'],'disabled'=> 'disabled' ])->label('Logros') ?>
