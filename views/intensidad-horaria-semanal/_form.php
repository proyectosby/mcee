...
$this->registerJsFile(Yii::$app->request->baseUrl.'/js/intensidadHorariaSemanal.js',['depends' => [\yii\web\JqueryAsset::className()]]);
?>
<style>
	.table{
		display: table;
...
<div class="intensidad-horaria-semanal-form">
