...
Descripción: Formulario para agregar Documentos Servicio Social
---------------------------------------
**********/
...
$this->registerJsFile(Yii::$app->request->baseUrl.'/js/documentosServicioSocial.js',['depends' => [\yii\web\JqueryAsset::className()]]);
