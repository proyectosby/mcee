    ...
    <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]cantidad_ieo')->textInput([ 'value' => isset($cantidad_ieo[1]) ? $cantidad_ieo[1] + $cantidad_ieo[2] +$cantidad_ieo[3] : '']) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]cantidad_sedes')->textInput([ 'value' => isset($cantidad_sedes_ieo[1]) ? $cantidad_sedes_ieo[1] + $cantidad_sedes_ieo[2]+ $cantidad_sedes_ieo[3] : '']) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]porcentaje_ieo')->textInput([ 'value' => isset($porcentaje_ieo[3]) ? ((($porcentaje_ieo[3]+ $porcentaje_ieo[2] + $porcentaje_ieo[1]) / 3) .'%') : '' ]) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]porcentaje_sedes')->textInput([ 'value' => isset($porcentaje_sedes[3]) ? ((($porcentaje_sedes[3]+ $porcentaje_sedes[2] + $porcentaje_sedes[1]) / 3) .'%') : '' ]) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]porcentaje_actividad_uno')->textInput([ 'value' => isset($porcentaje_actividad_uno[3]) ? ((($porcentaje_actividad_uno[3]+ $porcentaje_actividad_uno[2] + $porcentaje_actividad_uno[1]) / 3) .'%') : '']) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]porcentaje_actividad_dos')->textInput([ 'value' =>  isset($porcentaje_actividad_dos[3]) ? ((($porcentaje_actividad_dos[3]+ $porcentaje_actividad_dos[2] + $porcentaje_actividad_dos[1]) / 3) .'%') : '']) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]porcentaje_actividad_tres')->textInput([ 'value' =>  isset($porcentaje_actividad_tres[3]) ? ((($porcentaje_actividad_tres[3]+ $porcentaje_actividad_tres[2] + $porcentaje_actividad_tres[1]) / 3) .'%') : '']) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]poblacion_beneficiada_directa')->textInput([ 'value' => isset($poblacion_beneficiada_directa[1]) ? ($poblacion_beneficiada_directa[1] + $poblacion_beneficiada_directa[2] +$poblacion_beneficiada_directa[3]) : '' ]) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]poblacion_beneficiada_indirecta')->textInput([ 'value' => isset($poblacion_beneficiada_indirecta[1]) ? ($poblacion_beneficiada_indirecta[1] + $poblacion_beneficiada_indirecta[2] +$poblacion_beneficiada_indirecta[3]) : '' ]) ?></td>
                <td rowspan='1' colspan='1'><?= $form->field($model, '[4]alarmas_generales')->textInput([ 'value' => isset($alarmas_generales[1]) ? ($alarmas_generales[1] + $alarmas_generales[2] +$alarmas_generales[3]) : '']) ?></td>                
            </tr>
        </tbody>
