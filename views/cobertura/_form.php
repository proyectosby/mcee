	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td rowspan='1' colspan='1'><?= $form->field($cobertura, '[0]cantidad_niños_institucion')->textInput() ?></td>
				<td rowspan='1' colspan='1'><?= $form->field($cobertura, '[0]cantidad_niñas_institucion')->textInput() ?></td>
				<?php
					foreach($sedes as $key => $sede){
						?>
