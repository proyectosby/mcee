...
Descripción: Formulario Documentos Aliados
---------------------------------------
*/
...
$this->registerJsFile(Yii::$app->request->baseUrl.'/js/documentosAliados.js',['depends' => [\yii\web\JqueryAsset::className()]]);
	...
	<div id=dvTable class=table>
		...
		<div class=row>
			...
			<div class=cell style='display:none;'>
				<?= $form->field($model, '[0]id_institucion')->dropDownList( $instituciones ) ?>
			</div>

			<div class=cell>
				<?= $form->field($model, '[0]nombre')->dropDownList( $tiposDocumento, [ 'prompt' => 'Seleccione...' ] ) ?>
			</div>
			
			<div class=cell>
				<?= $form->field($model, '[0]tipo_documento')->dropDownList( [ 'Pública' => 'Pública', 'Privada' => 'Privada' ], [ 'prompt' => 'Seleccione...' ] ) ?>
			</div>
